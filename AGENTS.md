...
- use the credentials given in .env files for langsmith and groq api
...
- You should always verify things are being done correctly by checking the documentation of qdrant,langchain,fastapi which you have tools to inspect.  The best developers reference the documentation a lot.
